...
class Graph():
    ...
    def _graph_rhr(self, time, data, period, geometry=111):
        ...
        self._graph_multiple_single_axes(time, [rhr], 'Resting Heart Rate', 'rhr', self.save, geometry)
    ...
    def _graph_stress(self, time, data, period, geometry=111):
        """Generate a stress graph"""
        stress = [entry.stress_avg for entry in data]
        self._graph_multiple_single_axes(time, [stress], 'Stress', 'stress', self.save, geometry)
